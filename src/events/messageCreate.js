          ...
          return message.reply({
            embeds: [
              new EmbedBuilder()
                ...
                .setDescription(
                  `Hello, ${message.author}!\nYou've discovered an exclusive **premium command**.\n\n[Click here to upgrade](https://discord.gg/zenkai-headquarters-6-1363548442449674482)`
                ),
            ],
          });
        }
